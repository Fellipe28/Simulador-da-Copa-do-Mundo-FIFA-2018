...
import javax.swing.*;
public class GrupoD implements ActionListener{
	static String Selecoes[] = {"Argentina","Islândia","Croácia","Nigéria"};
    static String Bandeiras[] = {"Bandeiras/Argentina.png","Bandeiras/Islândia.png","Bandeiras/Croácia.png","Bandeiras/Nigéria.png"};
    String Stadiums[] = {"Bandeiras/Arena Otkrytie.jpg","Bandeiras/Estádio de Kaliningrado.jpg","Bandeiras/Estádio de Níjni Novgorod.jpg",
    		             "Bandeiras/Arena Volgogrado.jpg","Bandeiras/Estádio Krestovsky.jpg","Bandeiras/Arena Rostov.jpg"};
    String D1,D2;
    ...
    public GrupoD(){
    	...
    	String Cidades[] = {"Moscou","Kaliningrado","Níjni Novgorod","Volgogrado","São Petersburgo","Rostov do Don"};
    	String Estadios[] = {"Arena Otkrytie","Est. de Kaliningrado","Est. Níjni Novgorod","Arena Volgogrado","Estádio Krestovsky","Arena Rostov"};
    	String Datas[] = {"16 de junho","16 de junho","21 de junho","22 de junho","26 de junho","26 de junho"};
    	String Horas[] = {"10:00","16:00","15:00","12:00","15:00","15:00"};
    	...
    	setTable(Start);
    	Copa.OF.setPS(D1,6);Copa.OF.setPS(D2,3);
		Copa.OF.setBPS(BD1,6);Copa.OF.setBPS(BD2,3);
		Copa.OF.Times[18].setText(Copa.OF.getPS(6));Copa.OF.Times[7].setText(Copa.OF.getPS(3));
		Copa.OF.Bandeiras[18].setIcon(Copa.OF.getBPS(6));Copa.OF.Bandeiras[7].setIcon(Copa.OF.getBPS(3));
    	for(int i = 0; i < 6; i++){
    	...
    	JLabel Titulo = new JLabel("<html><br>Copa do Mundo FIFA de 2018 - Grupo D<br><br></html>");
    ...
    public ImageIcon getBD1(){
	    return BD1;
    }
    public ImageIcon getBD2(){
	    return BD2;
    }
    ...
    public void setTable(int k[]){
	    ...
	    for(int n = 0; n < 4; n++){
	    	if(Total < 12){
	    		D1 = "1º do Grupo D";D2 = "2º do Grupo D";
	    		BD1 = new ImageIcon(path + "Bandeiras/Indefinido.png");BD2 = new ImageIcon(path + "Bandeiras/Indefinido.png");
    			...
    			D1 = Selecoes[R[0]];D2 = Selecoes[R[1]];
    		    BD1 = new ImageIcon(path + "Bandeiras/" + Selecoes[R[0]] + ".png");BD2 = new ImageIcon(path + "Bandeiras/" + Selecoes[R[1]] + ".png");
    			if(n < 2){
