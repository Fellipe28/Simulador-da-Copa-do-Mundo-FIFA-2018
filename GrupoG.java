...
import javax.swing.*;
public class GrupoG implements ActionListener{
	static String Selecoes[] = {"Bélgica","Panamá","Tunísia","Inglaterra"};
    static String Bandeiras[] = {"Bandeiras/Bélgica.png","Bandeiras/Panamá.png","Bandeiras/Tunísia.png","Bandeiras/Inglaterra.png"};
    String Stadiums[] = {"Bandeiras/Estádio Olímpico de Fisht.jpg","Bandeiras/Arena Volgogrado.jpg","Bandeiras/Arena Otkrytie.jpg",
    		             "Bandeiras/Estádio de Níjni Novgorod.jpg","Bandeiras/Estádio de Kaliningrado.jpg","Bandeiras/Arena Mordovia.jpg"};
    String G1,G2;
    ...
    public GrupoG(){
    	...
    	String Cidades[] = {"Sóchi","Volgogrado","Moscou","Níjni Novgorod","Kaliningrado","Saransk"};
    	String Estadios[] = {"Est. Olím. de Fisht","Arena Volgogrado","Arena Otkrytie","Est. Níjni Novgorod","Est. de Kaliningrado","Arena Mordovia"};
    	String Datas[] = {"18 de junho","18 de junho","23 de junho","24 de junho","28 de junho","28 de junho"};
    	String Horas[] = {"12:00","15:00","09:00","09:00","15:00","15:00"};
    	...
    	setTable(Start);
    	Copa.OF.setPS(G1,10);Copa.OF.setPS(G2,15);
		Copa.OF.setBPS(BG1,10);Copa.OF.setBPS(BG2,15);
    ...
    public void setTable(int k[]){
	    ...
	    for(int n = 0; n < 4; n++){
	    	if(Total < 12){
	    		G1 = "1º do Grupo G";G2 = "2º do Grupo G";
		    	BG1 = new ImageIcon(path + "Bandeiras/Indefinido.png");BG2 = new ImageIcon(path + "Bandeiras/Indefinido.png");
    			...
    			G1 = Selecoes[R[0]];G2 = Selecoes[R[1]];
    		    BG1 = new ImageIcon(path + "Bandeiras/" + Selecoes[R[0]] + ".png");BG2 = new ImageIcon(path + "Bandeiras/" + Selecoes[R[1]] + ".png");
    			if(n < 2){
