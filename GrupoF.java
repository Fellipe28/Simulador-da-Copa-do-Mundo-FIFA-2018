...
import javax.swing.*;
public class GrupoF implements ActionListener{
	static String Selecoes[] = {"Alemanha","México","Suécia","Coreia do Sul"};
    static String Bandeiras[] = {"Bandeiras/Alemanha.png","Bandeiras/México.png","Bandeiras/Suécia.png","Bandeiras/Coreia do Sul.png"};
    String Stadiums[] = {"Bandeiras/Estádio Lujniki.jpg","Bandeiras/Estádio de Níjni Novgorod.jpg","Bandeiras/Estádio Olímpico de Fisht.jpg",
    		             "Bandeiras/Arena Rostov.jpg","Bandeiras/Arena Kazan.jpg","Bandeiras/Estádio Central.jpg"};
    String F1,F2;
    ...
    public GrupoF(){
    	...
    	String Cidades[] = {"Moscou","Níjni Novgorod","Sóchi","Rostov do Don","Cazã","Ecaterimburgo"};
    	String Estadios[] = {"Estádio Lujniki","Est. Níjni Novgorod","Est. Olím. de Fisht","Arena Rostov","Arena Kazan","Estádio Central"};
    	String Datas[] = {"17 de junho","18 de junho","23 de junho","23 de junho","27 de junho","27 de junho"};
    	...
    	setTable(Start);
    	Copa.OF.setPS(F1,12);Copa.OF.setPS(F2,9);
		Copa.OF.setBPS(BF1,12);Copa.OF.setBPS(BF2,9);
		Copa.OF.Times[36].setText(Copa.OF.getPS(12));Copa.OF.Times[25].setText(Copa.OF.getPS(9));
		Copa.OF.Bandeiras[36].setIcon(Copa.OF.getBPS(12));Copa.OF.Bandeiras[25].setIcon(Copa.OF.getBPS(9));
    	for(int i = 0; i < 6; i++){
    	...
    	JLabel Titulo = new JLabel("<html><br>Copa do Mundo FIFA de 2018 - Grupo F<br><br></html>");
    ...
    public ImageIcon getBF1(){
	    return BF1;
    }
    public ImageIcon getBF2(){
	    return BF2;
    }
    ...
    public void setTable(int k[]){
	    ...
	    for(int n = 0; n < 4; n++){
	    	if(Total < 12){
	    		F1 = "1º do Grupo F";F2 = "2º do Grupo F";
	    		BF1 = new ImageIcon(path + "Bandeiras/Indefinido.png");BF2 = new ImageIcon(path + "Bandeiras/Indefinido.png");
    			...
    			F1 = Selecoes[R[0]];F2 = Selecoes[R[1]];
    		    BF1 = new ImageIcon(path + "Bandeiras/" + Selecoes[R[0]] + ".png");BF2 = new ImageIcon(path + "Bandeiras/" + Selecoes[R[1]] + ".png");
    			if(n < 2){
