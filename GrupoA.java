...
import javax.swing.*;
public class GrupoA implements ActionListener{
	static String Selecoes[] = {"Rússia","Arábia Saudita","Egito","Uruguai"};
    static String Bandeiras[] = {"Bandeiras/Rússia.png","Bandeiras/Arábia Saudita.png","Bandeiras/Egito.png","Bandeiras/Uruguai.png"};
    String Stadiums[] = {"Bandeiras/Estádio Lujniki.jpg","Bandeiras/Estádio Central.jpg","Bandeiras/Estádio Krestovsky.jpg",
    		             "Bandeiras/Arena Rostov.jpg","Bandeiras/Estádio de Samara.jpg","Bandeiras/Arena Volgogrado.jpg"};
    String A1,A2;
    ...
    public GrupoA(){
    	...
    	String Cidades[] = {"Moscou","Ecaterimburgo","São Petersburgo","Rostov do Don","Samara","Volgogrado"};
    	String Estadios[] = {"Estádio Lujniki","Estádio Central","Estádio Krestovsky","Arena Rostov","Estádio de Samara","Arena Volgogrado"};
    	String Datas[] = {"14 de junho","15 de junho","19 de junho","20 de junho","25 de junho","25 de junho"};
    	...
    	setTable(Start);
    	Copa.OF.setPS(A1,0);Copa.OF.setPS(A2,5);
		Copa.OF.setBPS(BA1,0);Copa.OF.setBPS(BA2,5);
		Copa.OF.Times[0].setText(Copa.OF.getPS(0));Copa.OF.Times[13].setText(Copa.OF.getPS(5));
		Copa.OF.Bandeiras[0].setIcon(Copa.OF.getBPS(0));Copa.OF.Bandeiras[13].setIcon(Copa.OF.getBPS(5));
    	for(int i = 0; i < 6; i++){
    	...
    	JLabel Titulo = new JLabel("<html><br>Copa do Mundo FIFA de 2018 - Grupo A<br><br></html>");
    ...
    public ImageIcon getBA1(){
    	return BA1;
    }
    public ImageIcon getBA2(){
    	return BA2;
    }
    ...
    public JTextField getPlacar(int i){
    	return Placar[i];
    }
    ...
    public void setTable(int k[]){
    	...
    	for(int n = 0; n < 4; n++){
    		if(Total < 12){
    			A1 = "1º do Grupo A";A2 = "2º do Grupo A";
    			BA1 = new ImageIcon(path + "Bandeiras/Indefinido.png");BA2 = new ImageIcon(path + "Bandeiras/Indefinido.png");
    			...
    			A1 = Selecoes[R[0]];A2 = Selecoes[R[1]];
    	    	BA1 = new ImageIcon(path + "Bandeiras/" + Selecoes[R[0]] + ".png");BA2 = new ImageIcon(path + "Bandeiras/" + Selecoes[R[1]] + ".png");
    			if(n < 2){
