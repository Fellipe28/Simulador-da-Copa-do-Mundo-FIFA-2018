...
import javax.swing.*;
public class GrupoC implements ActionListener{
	static String Selecoes[] = {"França","Austrália","Peru","Dinamarca"};
    static String Bandeiras[] = {"Bandeiras/França.png","Bandeiras/Austrália.png","Bandeiras/Peru.png","Bandeiras/Dinamarca.png"};
    String Stadiums[] = {"Bandeiras/Arena Kazan.jpg","Bandeiras/Arena Mordovia.jpg","Bandeiras/Estádio de Samara.jpg",
    		             "Bandeiras/Estádio Central.jpg","Bandeiras/Estádio Lujniki.jpg","Bandeiras/Estádio Olímpico de Fisht.jpg"};
    String C1,C2;
    ...
    public GrupoC(){
    	...
    	String Cidades[] = {"Cazã","Saransk","Samara","Ecaterimburgo","Moscou","Sóchi"};
    	String Estadios[] = {"Arena Kazan","Arena Mordovia","Estádio de Samara","Estádio Central","Estádio Lujniki","Est. Olím. de Fisht"};
    	String Datas[] = {"16 de junho","16 de junho","21 de junho","21 de junho","26 de junho","26 de junho"};
    	String Horas[] = {"07:00","13:00","09:00","12:00","11:00","11:00"};
    	...
    	setTable(Start);
    	Copa.OF.setPS(C1,2);Copa.OF.setPS(C2,7);
		Copa.OF.setBPS(BC1,2);Copa.OF.setBPS(BC2,7);
		Copa.OF.Times[6].setText(Copa.OF.getPS(2));Copa.OF.Times[19].setText(Copa.OF.getPS(7));
		Copa.OF.Bandeiras[6].setIcon(Copa.OF.getBPS(2));Copa.OF.Bandeiras[19].setIcon(Copa.OF.getBPS(7));
    	for(int i = 0; i < 6; i++){
    	...
    	JLabel Titulo = new JLabel("<html><br>Copa do Mundo FIFA de 2018 - Grupo C<br><br></html>");
    ...
    public ImageIcon getBC1(){
	    return BC1;
    }
    public ImageIcon getBC2(){
	    return BC2;
    }
    ...
    public void setTable(int k[]){
	    ...
	    for(int n = 0; n < 4; n++){
	    	if(Total < 12){
	    		C1 = "1º do Grupo C";C2 = "2º do Grupo C";
	    		BC1 = new ImageIcon(path + "Bandeiras/Indefinido.png");BC2 = new ImageIcon(path + "Bandeiras/Indefinido.png");
    			...
    			C1 = Selecoes[R[0]];C2 = Selecoes[R[1]];
    		    BC1 = new ImageIcon(path + "Bandeiras/" + Selecoes[R[0]] + ".png");BC2 = new ImageIcon(path + "Bandeiras/" + Selecoes[R[1]] + ".png");
    			if(n < 2){
