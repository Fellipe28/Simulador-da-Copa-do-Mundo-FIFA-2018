...
import javax.swing.*;
public class GrupoE implements ActionListener{
	static String Selecoes[] = {"Brasil","Suíça","Costa Rica","Sérvia"};
    static String Bandeiras[] = {"Bandeiras/Brasil.png","Bandeiras/Suíça.png","Bandeiras/Costa Rica.png","Bandeiras/Sérvia.png"};
    String Stadiums[] = {"Bandeiras/Arena Rostov.jpg","Bandeiras/Estádio de Samara.jpg","Bandeiras/Estádio Krestovsky.jpg",
    		             "Bandeiras/Estádio de Kaliningrado.jpg","Bandeiras/Arena Otkrytie.jpg","Bandeiras/Estádio de Níjni Novgorod.jpg"};
    String E1,E2;
    ...
    public GrupoE(){
    	...
    	String Cidades[] = {"Rostov do Don","Samara","São Petersburgo","Kaliningrado","Moscou","Níjni Novgorod"};
    	String Estadios[] = {"Arena Rostov","Estádio de Samara","Estádio Krestovsky","Est. de Kaliningrado","Arena Otkrytie","Est. Níjni Novgorod"};
    	String Datas[] = {"17 de junho","17 de junho","22 de junho","22 de junho","27 de junho","27 de junho"};
    	String Horas[] = {"15:00","09:00","09:00","15:00","15:00","15:00"};
    	...
    	setTable(Start);
    	Copa.OF.setPS(E1,8);Copa.OF.setPS(E2,13);
		Copa.OF.setBPS(BE1,8);Copa.OF.setBPS(BE2,13);
		Copa.OF.Times[24].setText(Copa.OF.getPS(8));Copa.OF.Times[37].setText(Copa.OF.getPS(13));
		Copa.OF.Bandeiras[24].setIcon(Copa.OF.getBPS(8));Copa.OF.Bandeiras[37].setIcon(Copa.OF.getBPS(13));
    	for(int i = 0; i < 6; i++){
    	...
    	JLabel Titulo = new JLabel("<html><br>Copa do Mundo FIFA de 2018 - Grupo E<br><br></html>");
    ...
    public ImageIcon getBE1(){
	    return BE1;
    }
    public ImageIcon getBE2(){
	    return BE2;
    }
    ...
    public void setTable(int k[]){
	    ...
	    for(int n = 0; n < 4; n++){
	    	if(Total < 12){
	    		E1 = "1º do Grupo E";E2 = "2º do Grupo E";
	    		BE1 = new ImageIcon(path + "Bandeiras/Indefinido.png");BE2 = new ImageIcon(path + "Bandeiras/Indefinido.png");
    			...
    			E1 = Selecoes[R[0]];E2 = Selecoes[R[1]];
    		    BE1 = new ImageIcon(path + "Bandeiras/" + Selecoes[R[0]] + ".png");BE2 = new ImageIcon(path + "Bandeiras/" + Selecoes[R[1]] + ".png");
    			if(n < 2){
