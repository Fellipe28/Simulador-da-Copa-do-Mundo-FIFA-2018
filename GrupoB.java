...
import javax.swing.*;
public class GrupoB implements ActionListener{
	static String Selecoes[] = {"Portugal","Espanha","Marrocos","Irã"};
    static String Bandeiras[] = {"Bandeiras/Portugal.png","Bandeiras/Espanha.png","Bandeiras/Marrocos.png","Bandeiras/Irã.png"};
    String Stadiums[] = {"Bandeiras/Estádio Krestovsky.jpg","Bandeiras/Estádio Olímpico de Fisht.jpg","Bandeiras/Estádio Lujniki.jpg",
    		             "Bandeiras/Arena Kazan.jpg","Bandeiras/Arena Mordovia.jpg","Bandeiras/Estádio de Kaliningrado.jpg"};
    String B1,B2;
    ...
    public GrupoB(){
    	...
    	String Cidades[] = {"São Petersburgo","Sóchi","Moscou","Cazã","Saransk","Kaliningrado"};
    	String Estadios[] = {"Estádio Krestovsky","Est. Olím. de Fisht","Estádio Lujniki","Arena Kazan","Arena Mordovia","Est. de Kaliningrado"};
    	String Datas[] = {"15 de junho","15 de junho","20 de junho","20 de junho","25 de junho","25 de junho"};
    	String Horas[] = {"15:00","12:00","09:00","15:00","15:00","15:00"};
    	...
    	setTable(Start);
    	Copa.OF.setPS(B1,4);Copa.OF.setPS(B2,1);
		Copa.OF.setBPS(BB1,4);Copa.OF.setBPS(BB2,1);
		Copa.OF.Times[12].setText(Copa.OF.getPS(4));Copa.OF.Times[1].setText(Copa.OF.getPS(1));
		Copa.OF.Bandeiras[12].setIcon(Copa.OF.getBPS(4));Copa.OF.Bandeiras[1].setIcon(Copa.OF.getBPS(1));
    	for(int i = 0; i < 6; i++){
    	...
    	JLabel Titulo = new JLabel("<html><br>Copa do Mundo FIFA de 2018 - Grupo B<br><br></html>");
    ...
    public ImageIcon getBB1(){
	    return BB1;
    }
    public ImageIcon getBB2(){
	    return BB2;
    }
    ...
    public void setTable(int k[]){
	    ...
	    for(int n = 0; n < 4; n++){
	    	if(Total < 12){
	    		B1 = "1º do Grupo B";B2 = "2º do Grupo B";
	    		BB1 = new ImageIcon(path + "Bandeiras/Indefinido.png");BB2 = new ImageIcon(path + "Bandeiras/Indefinido.png");
    			...
    			B1 = Selecoes[R[0]];B2 = Selecoes[R[1]];
    		    BB1 = new ImageIcon(path + "Bandeiras/" + Selecoes[R[0]] + ".png");BB2 = new ImageIcon(path + "Bandeiras/" + Selecoes[R[1]] + ".png");
    			if(n < 2){
